...
export default function Pergunta6() {
  // Captura os parâmetros enviados pela tela anterior (Pergunta 5)
  ...
  const responder = (acertou: boolean) => {
    // Calcula os novos pontos e envia para a Próxima Tela
    let pontosAtuais = pontosRecebidos;
    if (acertou) { 
      pontosAtuais = pontosRecebidos + 1; 
    }
    
    // Avança para a pergunta 7 sem a extensão ".tsx"
    router.push({ 
