...
export default function Pergunta7() {
  // Captura os parâmetros enviados pela tela anterior (Pergunta 6)
  ...
  const responder = (acertou: boolean) => {
    ...
    // Navega para a próxima pergunta (Pergunta 8)
    router.push({ 
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Nova pergunta sobre o Brasil na Copa do Mundo */}
