...
export default function Pergunta8() {
  // Captura os parâmetros enviados pela tela anterior (Pergunta 7)
  ...
  const responder = (acertou: boolean) => {
    ...
    // CORRIGIDO: Avança para a próxima tela (/pergunta9) sem usar ".tsx" para evitar erros no navegador
    router.push({ 
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Nova pergunta sobre o VAR na Copa do Mundo */}
